      ...
      <div className="flex flex-col items-center gap-3 justify-center h-1/2 flex-grow w-full max-w-[1330px] relative px-5 lg:px-10">
        <div className="flex flex-col items-center w-full max-w-max  my-auto">
          ...
          <motion.p
            ...
            Thank you for attending Onelove Fest &apos;24. Stay tuned for updates and announcements
            for Onelove Fest &apos;25.
          </motion.p>
          <motion.form
            initial={{ opacity: 0 }}
            ...
            <input
              ...
              type="email"
            />
            <button className="bg-peach/90 border-peach border-2 border-l-0  rounded-br-lg rounded-tr-lg text-white lg:text-xl px-3  lg:px-8 flex-shrink-0 uppercase  darma-e transition-all hover:text-lemon ">
              subscribe
            </button>
          </motion.form>
