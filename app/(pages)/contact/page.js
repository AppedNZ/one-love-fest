...
export default function FAQ() {
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="w-full  flex  flex-col h-2/3 flex-grow overflow-hidden bg-white border-2 border-gray-400/50 rounded-10  gap-5 p-4 2xl:p-8 uppercase  text-black ">
      <div className="flex flex-col flex-grow h-full ">
        <h5 className="text-3xl 2xl:text-6xl text-black ">Get Support</h5>
        ...
        <div className="flex flex-col h-1/2 flex-grow  w-full">
          <div className=" w-full  border-b border-white/20 flex-grow flex flex-col items-start justify-center gap-2 max-lg:py-4 max-h-32">
            ...
            <p className="text-md 2xl:text-2xl">
              <a
                ...
                className="text-black underline hover:text-mustard">
          ...
          <div className=" w-full   flex-grow flex flex-col items-start justify-center gap-2 max-lg:py-4 max-h-32">
            <p className=" text-mustard text-left text-xl 2xl:text-3xl">Media & Sponsorship</p>
            <p className="text-md 2xl:text-2xl">
              <a
